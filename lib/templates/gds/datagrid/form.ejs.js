...
__p += '<th class="govuk-table__header"></th>';
 } ;
__p += '\n        ';
...
'-row" class="govuk-table__row">\n        ';
 if (ctx.component.reorder) { ;
__p += '\n        <td class="govuk-table__cell" >\n            <button type="button" style="position: absolute;margin-top: 15px;" title="Reorder item" class="formio-drag-button govuk-button govuk-button--secondary"> <i class="fa fa-bars"></i></button>\n        </td>\n        ';
 } ;
__p += '\n        ';
 ctx.columns.forEach(function(col) { ;
__p += '\n        <td ref="' +
...
__p += '\n        <td class="govuk-table__cell">\n            <button aria-label="Remove item" title="Remove item" type="button" class="govuk-button govuk-button--warning" ref="' +
((__t = (ctx.datagridKey)) == null ? '' : __t) +
